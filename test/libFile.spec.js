...
describe('Library "file"', () => {
    ...
    describe("file.isText", () => {
        ...
        it("does not recognize a binary file", async () => {
            assert(!(await file.isText(binFilePath)))
        })
    })
    ...
    describe("file.isMarkdown", () => {
        ...
        it("recognizes a Markdown file with uppercase extension", () => {
            assert(file.isMarkdown(mdFilePath.toUpperCase()))
        })
